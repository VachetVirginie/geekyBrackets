...
module.exports = {
  siteName: process.env.SITE_NAME || 'Geeky Brackets',
  siteDescription:
    process.env.SITE_DESCRIPTION ||
    'Geeky Brackets Blog covers Technologies, Tips and Tricks, How to, Blogging, Programming etc.',
  siteUrl: process.env.GRIDSOME_BASE_URL || 'https://vivi.github.com',
  icon: {
    favicon: {
      ...
      options: {
        ...
        feedOptions: {
          ...
          feed_url: process.env.GRIDSOME_BASE_URL
            ...
            : 'https://vivvi.github.com/rss.xml',
          site_url:
            process.env.GRIDSOME_BASE_URL || 'https://vivvi.github.com/',
        },
        feedItemOptions: (node) => ({
          ...
          url: process.env.GRIDSOME_BASE_URL
            ...
            : 'https://vivvi.github.com' + node.path,
          author: process.env.SITE_AUTHOR || 'Vivvi',
          date: node.date,
        }),
        output: {
          dir: './static',
